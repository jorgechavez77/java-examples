 ...
 * LICENSE.txt file.
 */
package org.mule.example.myhelloapp;
...
public class MyHelloAppTestCase extends FunctionalTestCase {
	...
	@Test
	public void myhelloapp() throws Exception {
		MuleClient client = muleContext.getClient();

		DefaultMuleMessage message = new DefaultMuleMessage("some data",
				muleContext);
