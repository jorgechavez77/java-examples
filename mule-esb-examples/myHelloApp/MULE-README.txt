...
-----------------------------------------------------------------
./src/test/java/org/mule/example/myhelloapp/MyHelloAppTestCase.java
...
-----------------------------------------------------------------
./src/test/resources/myhelloapp-functional-test-config.xml

Defines the Mule configuration for the MyHelloAppTestCase.java.
...
artifactId=myhelloapp
description=Hello World
muleVersion=3.7.0
packagePath=com/mycompany/mule
forgeProject=n
transports=http,vm
modules=xml,json,client

version=1.0-SNAPSHOT
groupId=org.mule.example
basedir=c:\Users\jachavez\local\examples
--------------------------------------------------------------------